...
static int evilunit_implementation_test(struct evilunit_module_state * state, const char *blockname);
static void evilunit_implementation_depends(struct evilunit_module_state * state, evilunit_node_type proposed);
...
static struct evilunit_test_state evilunit_make_test_state(const char * module_name)
{
...
static void evilunit_clear_module_state(evilunit_node_type node, struct evilunit_module_state * module)
{
...
static struct evilunit_test_state evilunit_walk_graph_recursive(evilunit_node_type node, evilunit_visit visitor, evilunit_reduce reducor)
{
  ...
  struct evilunit_test_state retval = evilunit_make_test_state(evilunit_query_module_name(node));
  struct evilunit_test_state result = evilunit_make_test_state(evilunit_query_module_name(node));
...
static struct evilunit_test_state evilunit_collapse_visitor(evilunit_node_type node)
{
  struct evilunit_test_state result = evilunit_query_result(node);
  if (result.number_failure == 0)
    {
      struct evilunit_test_state erasure = evilunit_make_test_state(evilunit_query_module_name(node));
...
static struct evilunit_test_state evilunit_collapse_reducor(struct evilunit_test_state previous, struct evilunit_test_state current)
{
...
static struct evilunit_test_state evilunit_output_visitor(evilunit_node_type node)
{
...
{
  struct evilunit_test_state res = evilunit_walk_graph(root,evilunit_output_visitor,evilunit_nop_reducor);
  (void)res;
}
...
{
  struct evilunit_test_state res = evilunit_walk_graph(root,evilunit_collapse_visitor,evilunit_collapse_reducor);
