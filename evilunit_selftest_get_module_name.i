  ...
  TEST("Retrieve name of a different module")
    {
      ...
      CHECK(strcmp(modulename, "uninteresting_module") == 0);
    }
 

  TEST("Retrieve name of this module")
    {
      CHECK(strcmp(evilunit_query_module_name(EVILUNIT_MODULE_MANGLE(get_module_name_from_function)), "get_module_name_from_function") == 0);
    }
  ...
  TEST("Retrieve name of dependency")
    {
      ...
      CHECK(dependency != 0);
      CHECK(strcmp(evilunit_query_module_name(dependency), "uninteresting_module")==0);
    }
}
...
static MODULE(get_module_name_from_test)
{
  ...
  CHECK(strcmp(expect.testname_string, result.testname_string)==0);
}
